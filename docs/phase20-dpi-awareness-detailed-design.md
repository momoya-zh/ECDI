...
> 状态：**v1.2**（2026-09-24）——✅ **已实施：五批全部落地 · 四工具链构建 + 测试全绿**（用例 **236 → 247**）；★ **待人工验收**（P1–P4 实测 · 125%/150% 目视）。★ **v1.2 记录 4 处实施偏离**（见 **§14**）
...
| **A4** 感知声明生效 | ⬜ **待核**（§5.2 诊断日志 / `GetProcessDpiAwareness`） |
| **A5** 视觉 | ✅ **100%**（批四，ModelProbe 行为一致）· ⬜ **125% / 150% 待实测**（§8.1） |
| **A6** 跨屏正确 | ⬜ **待实测**（§8.1 · ★ P1/P2/P3 目视可判） |
