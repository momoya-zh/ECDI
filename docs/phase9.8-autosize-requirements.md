...
> 状态：✅ **完成**（v1.5 定稿；2026-09-02 已实现——151 测试全绿，ModelProbe 消费验证）
> 前置：ModelProbe P1 实操暴露（用户观察：「我们其实缺少自适应尺寸的功能」）
> 文档目录：框架能力 → docs/（与 phase9.6-* 同级）；ModelProbe demo 文档 → `docs/model-probe/`（2026-09-11 从仓库根的 `model-probe-docs/` 移入）
