...
## Phase11 图片解码（🚧 需求 v1.1 ✅ / 初设 v1.1 ✅ / 详设 v1.1 ✅ → 待实施）
...
| [phase11-image-decode-detailed-design.md](phase11-image-decode-detailed-design.md) | 详细设计（6 开放点全收：initguid+IID_PPV_ARGS 零 uuid.lib / ComRAII 模板 / 溢出两步数学界 / SH 主案+IStream 预案 / 测试资产生成策略 / 验收 6 项） | ✅ v1.1 已评审（基本通过，修订 7 项——可进实施） |
