...
## Phase16 桌面驻留层（`WindowLayer::Desktop`）（✅ 需求确认 v1.4 · ✅ 初步设计 v1.3 · ✅ 详细设计 v1.2——**评审「设计上通过，可进实现」**）
