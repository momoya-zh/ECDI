...
## Phase16 桌面驻留层（`WindowLayer::Desktop`）（✅ 需求确认 v1.4 · ✅ 初步设计 v1.3 · ✅ 详细设计 v1.8 · 🚧 **已实施（批 A/B/C + A5 跟随修复 + T16-8）——待验收 A1–A8**）
