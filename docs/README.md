...
## Phase20.1 渲染层 DPI 缩放（render DPI scaling）（✅ 需求 **v1.1**（+ **v1.2** 勘误）· ✅ 初步设计 **v1.1 已通过** · 🚧 详细设计 **v1.0 待评审**，2026-09-24 立项）
