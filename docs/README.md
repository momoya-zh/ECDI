...
## Phase19 鼠标事件维度补全（Mouse event dimensions）（需求 **v1.1 ✅** · 初步设计 **v1.1 ✅** · 详细设计 **v1.0 🚧 待评审**——2026-09-22 立项 / **2026-09-23 两轮评审通过并完成详设**）
