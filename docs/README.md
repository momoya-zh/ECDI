...
## Phase21 系统图标 → Image（icon to image）（🚧 需求确认 **v1.0 待评审**，2026-09-25 立项）
...
| 文档 | 内容 | 状态 |
|------|------|------|
| [phase21-icon-to-image-requirements.md](phase21-icon-to-image-requirements.md) | 需求确认（**K1–K6 现状勘察**（全部带行号）· **R1–R5** · **D0–D5 决策点** · **N1–N5 非目标** · **Q1–Q4**（★ **Q3 可测性**）· **A1–A5** · ★ §8 如实标注**消费者是未来的**） | 🚧 **v1.0 待评审** |
